...
public class LogFilter implements Filter {
    ...
    public LogFilter(BukkitPlugin plugin) {
        this.pl = plugin;
    }

    public Filter.Result checkMessage(String message) {
        if (!this.pl.getConfigHandler().getStringList("filter").isEmpty()) {
            for (String s : this.pl.getConfigHandler().getStringList("filter")) {
